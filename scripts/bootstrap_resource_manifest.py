...
FOLDER_BUNDLES = [
    ...
    ("zip-ifbs-theme34-yue", "IFBS2_Yue_theme3_theme4", "IFBS2", "Yue", "ZJE_Collection/zip_contents/IFBS2_Yue_theme3_theme4.md"),
    ("zip-pon-yue", "PoN3_Yue_notes", "PoN3", "Yue", "ZJE_Collection/zip_contents/PoN3_Yue_notes.md"),
    ("zip-bg2-sum-yiru", "BG2_Yiru_summary", "BG2", "Yiru", "ZJE_Collection/zip_contents/BG2_Yiru_summary.md"),
    ("zip-code-cheatsheet-yiru", "Code_Cheatsheet_Yiru_collection", "Code_Cheatsheet", "Yiru", "ZJE_Collection/zip_contents/Code_Cheatsheet_Yiru_collection.md"),
    ("zip-gp2-sum-yiru", "GP2_Yiru_summary", "GP2", "Yiru", "ZJE_Collection/zip_contents/GP2_Yiru_summary.md"),
    ("zip-ibms3-full-yiru", "IBMS3_Yiru_full_notes", "IBMS3", "Yiru", "ZJE_Collection/zip_contents/IBMS3_Yiru_full_notes.md"),
    ("zip-iid4-full-yiru", "IID4_Yiru_full_notes", "IID_4", "Yiru", "ZJE_Collection/zip_contents/IID4_Yiru_full_notes.md"),
    ("zip-mbe3-sum-yiru", "MBE3_Yiru_summary", "MBE3", "Yiru", "ZJE_Collection/zip_contents/MBE3_Yiru_summary.md"),
    ("zip-pon3-full-yiru", "PoN3_Yiru_full_notes", "PoN3", "Yiru", "ZJE_Collection/zip_contents/PoN3_Yiru_full_notes.md"),
]
