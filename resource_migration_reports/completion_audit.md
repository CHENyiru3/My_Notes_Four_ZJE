...
|---|---|---|---|---|
| Phase 0 | Manifest exists and every resource has an id. | pass | 68 resources loaded from ZJE_Collection/resources/resource_manifest.yml |  |
...
| Phase 3 | All non-retired manifest payloads exist under the OneDrive resource root. | pass | present: 40; missing: 0; unavailable: 25 |  |
...
| Phase 3 | Folder bundles are materialized and no source bundle work remains. | fail | present: 10; unavailable: 5; ready to materialize: 0; source files required: 0; no listed files: 0 |  |
...
| Phase 4 | All public release statuses and URLs are internally consistent. | pass | released: 40; pending: 25; retired: 3 |  |
| Phase 4 | All non-retired resources have maintainer-approved public resource links. | fail | released: 40; pending: 25; retired: 3 | Release pending large archives with manual OneDrive links or `scripts/create_onedrive_share_links.py` using an existing Entra app id. |
| Phase 5 | Public download CSV contains exactly the released resources and only approved public resource URLs. | pass | 40 rows in ZJE_Collection/resources/download_links.csv |  |
