...
Welcome — this site is generated from the repository's ZJE courses folder, containing study notes and materials. This website is open-sourced, which means you can feel free to download or fork.

If you have any questions, find me on xhs @生成一只头上戴花花的小momo, or via email: c1556613010@outlook.com. You are very welcome to contribute to this repo!

---

Jump to: [Quick Links](#quick-links) | [Year 1](#year-1) | [Year 2](#year-2) | [Year 3](#year-3) | [Year 4](#year-4) | [Contributors](#contributors) | [Contribution Guide](#contribution-guide)
...
Thank you all! If you find anything wrong, please let me know and I will fix it.

---

## Contribution Guide

Thank you for considering contributing! Before you start, please read:

1. **Markdown files**: Fully supported. Ensure images are not local (uploaded images work automatically).
2. **Resource files**: Do not commit PDFs, ZIPs, DOCX, PPTX, XLSX, videos, or large images to Git. Send them to the maintainer for OneDrive review and release.
3. **Special formats**: OneNote, mind maps, etc. Send them to the maintainer or provide a cloud link for review.
4. **Exam materials**: Not allowed (per school policy). Study notes and summaries are welcome.
5. **Questions?**: Contact me anytime!
